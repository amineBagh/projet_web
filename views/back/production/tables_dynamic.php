<?php
  ...
  if (isset($_POST['nomcat'])) // on verifie si le contenu de la variable est non vide
  {  
...
<html lang="en">
  ...
  <body class="nav-md">
   ...
   <tr>
     ...
     <td><a onclick="return confirm('voulez-vous vraiment supprimer cette categorie ?')" href="supprimercat.php?id_cat=<?= $categorie->id_cat?>" class="btn btn-danger"> supprimer </a> 
     <a  href="modifiercategorie.php?id_cat=<?= $categorie->id_cat?>" class="btn btn-danger"> modifier </a>
              ...
              <form  class="form-container" method="post">
                ...
                <input type="text" class="form-control" name="nomcat" placeholder="nom categorie" id="nomcat" required>

                <button type="submit" class="btn btn-info"  href="tables_dynamic.php ">ajouter categorie</button>
   ...
   <tr>
     ...
     <td><a onclick="return confirm('voulez-vous vraiment supprimer ce produit ?')" href="supprimerprod.php?id_produit=<?= $produit->id_produit?>" class="btn btn-danger"> supprimer </a>       </td>
