<?php
  ...
  $categorieC = new categorieC();         // pq on a pas fait l'instanciation de categorie 
  ...
  if (isset($_POST['modifier'])){
   ...
   $categorie=new categorie($nom_cat);
...
<?php
if (($_GET['id_cat'])){
$result=$categorieC->categorie_details($_GET['id_cat']);
...
<th><input type="number" name="id_cat" value="<?php echo $row['id_cat'] ?>" readonly class="form-control" ></th>
...
<tr>
     ...
     <th scope="col">nom   <br></th>
<th><input type="text" name="nom_cat" value="<?php echo $row['nom_cat'] ?>"  ></th>
...
<input type="hidden" name="id_ini" value="<?php echo $row['id_cat'] ?>">  </th>
<a href="tables_dynamic.php " class="btn btn-danger"> Retour </a>
</tr>
