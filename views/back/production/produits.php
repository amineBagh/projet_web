<?php
  ...
  $categories=$produitC->afficher_cat();
    ...
    if (isset($_POST['titre']) && isset($_POST['img']) && isset($_POST['descr']) && isset($_POST['prix']))

    {
     ...
     $produit= new produit($titre,$image,$description,$prix);
     $produitC=new produitC();
...
<html lang="en">
  ...
  <body class="nav-md">
       ...
       <div class="card-body">
              ...
              <?php 
                        ...
                        if(isset($_POST['rechercher']))
                        {
                          ...
                          $listeProduit=$produitC->rechercherproduit($titre,$descr,$prix,$categorier);
                        }
               ?>
   ...
   <tr>
     ...
     <td> <?= $produit->titre; ?> </td>
     <td> <?= $produit->descr; ?> </td>
     <td><img  src="images/<?= $produit->img; ?>" title="cliquez pour agrandir" style="width: 60px;height: 60px;cursor: pointer;" 
    ...
    <input type="text" class="form-control" name="titre" placeholder="titre" id="titre" required="true" pattern="[A-Za-z]+" 
    ...
    <input type="text" class="form-control" name="descr" placeholder="descr" id="descr" required="true" pattern="[A-Za-z]+" 
    title="lettres seulement"  >
    ...
    <button type="submit" class="btn btn-info"  href="produits.php ">ajouter produit</button>
