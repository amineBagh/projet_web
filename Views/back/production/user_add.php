...
if (isset($_POST['ajouter'])) {
	...
	if ($password == $password2) {
		$add_user->ajouterAdmin(new User(
			$nom        = $_POST['firstName'],
				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						...
						<div class="profile_info">
							<span>Welcome,</span>
							<h2><?php echo $add_user->recupererAdmin($_SESSION['uuid'])['nom'] . " " . $add_user->recupererAdmin($_SESSION['uuid'])['prenom']  ?></h2>
						</div>
					</div>
					<!-- /menu profile quick info -->
									...
									<form class="" action="" method="post" novalidate>
										...
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input class="form-control" data-validate-length-range="4" data-validate-words="1" name="lastName" placeholder="ex. f. Kennedy" required="required" />
											</div>
										</div>
										<!-- prenom -->
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input class="form-control" data-validate-length-range="4" data-validate-words="1" name="firstName" placeholder="ex. John" required="required" />
											</div>
										</div>
										...
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input class="form-control" name="email" class='email' data-validate-linked="email" required="required" type="email" />
											</div>
										</div>
										<!-- date de naissance -->
										<div class="field item form-group">
