...
$offreC = new offreC();
$listeoffres = $offreC->afficheroff();
...
if (isset($_POST['modifier'])) {
  ...
  $offreC->modifieroff($offre, $_POST['ref']);
}
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        ...
                        <?php
                        if (($_GET['ref'])) {
                          $result = $offreC->offre_details($_GET['ref']);
                        ...
                        ?>
                            ...
                            <form class="form-container" method="post">
                              ...
                              <tr>
                                ...
                                <th><input type="number" name="ref" value="<?php echo $row['ref'] ?>" readonly class="form-control"></th>
                              ...
                              <tr>
                                ...
                                <th scope="col">taux_reduc <br></th>
                                <th><input type="text" name="taux_reduc" value="<?php echo $row['taux_reduc'] ?>"></th>
                              ...
                              <tr>
                                ...
                                <th scope="col">nv_prix <br></th>
                                <th><input type="text" name="nv_prix" value="<?php echo $row['nv_prix'] ?>"></th>
                              ...
                              <tr>
                                ...
                                <th><input type="submit" class="btn btn-info" name="modifier" value="modifier">
                                  <input type="hidden" name="id_ini" value="<?php echo $row['ref'] ?>">
                                </th>
                                <a href="offres.php " class="btn btn-danger"> Retour </a>
                              </tr>
