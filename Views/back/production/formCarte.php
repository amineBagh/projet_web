...
<body class="nav-md">
  ...
  foreach($listeC as $ca){
	  ?>
			...
			<tr>
			<td><?php echo $ca['ref']; ?></td>
			  <td><?php echo $ca['idClient']; ?></td>
			  <td><?php echo $ca['code']; ?></td>
</td>
			 
			  <td><a href="supprimerCarte.php?id=<?php echo $ca['ref']; ?>" class="ico del">Delete</a> </td>
			  <td> <a href="modifierCarte.php?id=<?php echo $ca['ref']; ?>" class="ico edit">Edit</a>
							...
							<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
								...
								<div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 ">
										<input type="number" name="idClient" id="idClient" required="required" class="form-control ">
									</div>
								</div>
								<div class="item form-group">
