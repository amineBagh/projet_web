          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-20 col-sm-20 ">
                <div class="x_panel">
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                    <thead>
                    <tr>
                    <th style="color:purpule;" style="font-size:70;">ID</th>
                    <th style="color:purple;" style="font-size:70;">Nom</th>
                    <th style="color:purple;" style="font-size:70;">Prenom</th>
                    <th style="color:purple;" style="font-size:70;">adreese</th>
                    <th style="color:purple;" style="font-size:70;">Numero de telephone</th>
                    <th style="color:purple;" style="font-size:70;">Mail</th>
                    <th style="color:purple;" style="font-size:70;">livreurId</th>
                    <!--<th>livreur</th>-->
              ...
              ?>
                      ...
                      <td><?PHP echo $livraison['tel']; ?></td>
                      <td><?PHP echo $livraison['mail']; ?></td>
                     <td> <?PHP echo $livraison['livreurId']; ?></td>
                   ...
                   <a href="assignerlivreur.php?id=<?PHP echo $livraison['id']; ?>">
                     assigner livreur</a> 
