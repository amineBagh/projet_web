...
$carteC = new carteC();
$listeC = $carteC->afficherCarte();

$liste_user = $carteC->afficher_user();



if (isset($_POST['ajout-cart'])) {
  // mail("iyadhhmed@gmail.com", "subject", "message");
  $client = $_POST['client'];
  ...
  $carte = new carte($nbpoint);
  $carteC = new carteC();
  $carteC->ajoutercarte($carte, $client);

  // mail("amina.mtiri@esprit.tn", "test", "message");
                ...
                <div class="card-box table-responsive">
                  ...
                  <div class="card-body">
                    ...
                    <table width="100%" border="3" cellspacing="0" cellpadding="0">
                      ...
                      <?php
                      foreach ($listeC as $carte) {
                      ?>


                        <tr>
                          <td><?php echo $carte['ref']; ?></td>
                          <td><?php echo $carte['client']; ?></td>
                          <td><?php echo $carte['nbpoint']; ?></td>

                          </td>

                          <!-- <td><a href="modifierCarte.php?id=<?php echo $carte['ref']; ?>" class="ico del">Edit</a> </td> -->
                          <td><a href="supprimerCarte.php?id=<?php echo $carte['ref']; ?>" class="ico del">Delete</a> </td>
                        </tr>
                      <?php } ?>
                    ...
                    <form class="form-container" method="post" name="f" onsubmit="return verif()">
                      ...
                      <select name="client" id="client" class="form-control">
                        <?php foreach ($liste_user as $row) { ?>
                          <option value="<?php echo $row['id'] ?>"><?php echo $row['nom'] ?> <?php echo $row['prenom'] ?> <?php echo $row['numero'] ?></option>
                        <?php } ?>
                      </select>



                      <button type="submit" class="btn btn-info" name="ajout-cart">ajouter carte</button>
