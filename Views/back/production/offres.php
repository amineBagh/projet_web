...
include_once 'C:/xampp/htdocs/pharmaland/Models/offre.php';
include_once 'C:/xampp/htdocs/pharmaland/Controllers/offreC.php';

$offreC = new offreC();
$listeC = $offreC->afficherOffre();
$produits = $offreC->afficher_prod();


if (isset($_POST['description']) && isset($_POST['taux_reduc']) && isset($_POST['nv_prix'])) {
  ...
  $offre = new offre($description, $taux_reduc, $nv_prix);
  $offreC = new offreC();
  $offreC->ajouteroffre($offre, $produit);
                  ...
                  <div class="card-body">
                    ...
                    <table width="100%" border="3" cellspacing="0" cellpadding="0">
                      ...
                      ?>
                        ...
                        <tr>
                          <td><?php echo $of['ref']; ?></td>
                          <td><?php echo $of['produit']; ?></td>
                          <td><?php echo $of['description']; ?></td>
                          <td><?php echo $of['taux_reduc']; ?></td>
                          <td><?php echo $of['nv_prix']; ?></td>
                          </td>

                          <td><a href="supprimerOffre.php?id=<?php echo $of['ref']; ?>" class="ico del">Delete</a> </td>
                          <td> <a href="modifieroff.php?ref=<?php echo $of['ref']; ?>" class="ico edit">Edit</a>
                    ...
                    <br>
                    <!--     Input Ajout Produit   -->
                    <form class="form-container" method="post" name="f" onsubmit="return verif()">
                      ...
                      <select name="produit" id="produit" class="form-control">
                        <?php foreach ($produits as $row) { ?>
                          <option value="<?php echo $row['id_produit'] ?>"><?php echo $row['titre'] ?></option>
                        <?php } ?>
                      </select>


                      <label for="description">description</label>
                      <input type="text" class="form-control" name="description" placeholder="description" id="description" required="true">



                      <label for="taux_reduc">taux_reduc</label>
                      <input type="text" class="form-control" name="taux_reduc" placeholder="taux_reduc" id="taux_reduc" required="true">

                      <label for="nv_prix">nv_prix</label>
                      <input type="text" class="form-control" name="nv_prix" placeholder="nv_prix" id="nv_prix" required="true">
                      ...
                      <button type="submit" class="btn btn-info" href="offres.php ">ajouter offres</button>
