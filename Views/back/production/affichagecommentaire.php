<?php 
include_once 'C:/xampp/htdocs/pharmaland/Models/commentaire.php';
include_once 'C:/xampp/htdocs/pharmaland/controllers/commentaireC.php';
$commentaireC = new commentaireC();
$listeC = $commentaireC->afficherCommentaire();

function getData()
{
    $commentaireC = new commentaireC();
    return  $commentaireC->afficherCommentaire();
}
function searchData($ref)
{
    $commentaireC = new commentaireC();
    return $commentaireC->cherchernom($ref);
}

if (isset($_GET['chercher'])) {

    $listeC = searchData($_GET['chercher']);
...
if (isset($_POST["tri"])) {
	if(!empty($_POST["tri"]))
	$listeC = $commentaireC->afficherCommentaireTrie( $_POST['tri']);
	}
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="nav-md">
                    ...
                    <div class="header">
                        <div>
                            <form method="GET" action="" style="display: flex; align-items: center;">
                                <input type="text" class="form-control" name="chercher" placeholder="Chercher par reference">
                                <button class="btn btn-default btn-theme-light" type="submit">
  ...
  <div class="table">
		  ...
		  <table width="100%" border="3" cellspacing="0" cellpadding="0" >
			...
			<?php
  foreach($listeC as $comm){
	  ?>


			<tr>
			<td><?php echo $comm['ref']; ?></td>
			  <td><?php echo $comm['idProduit']; ?></td>
			  <td><?php echo $comm['texte']; ?></td>
</td>
			 
			  <td><a href="supprimercommentaire.php?id=<?php echo $comm['ref']; ?>" class="ico del">Delete</a> </td>
			  <td> <a href="modifiercommentaire.php?id=<?php echo $comm['ref']; ?>" class="ico edit">Edit</a>
							...
							<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
								...
								<div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 ">
										<input type="number" name="idProduit" id="idProduit" required="required" class="form-control ">
									</div>
								</div>
								<div class="item form-group">
