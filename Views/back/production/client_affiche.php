...
$logout = new Auth("", "");
$queries = $user->afficherUtilisateur()->fetchAll();
...
if (isset($_POST['filtre'])) {
    $queries = $user->chercherUtilisateur($_POST['cherche']);
}

if (isset($_POST['trier'])) {
    $queries = $user->trierUtilisateur();
}
...
<head>
    ...
    <title>Pharmaland | Afficher </title>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="even pointer">
                                                    ...
                                                    <td class=" "><?php if ($value['numero'])  echo $value['numero'];
                                                                    else echo "N/A" ?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
