...
if (isset($_POST['connecter'])) {
    ...
    $register = new ClientAuthController($email, $psswd);
    $register->seConnecterClient();
    header("Location: index.php");
    // echo "<pre>";
    // var_dump($_SESSION);
    // echo "</pre>";
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5">
                <span class="px-2">Connecter a votre Compte</span>
            </h2>
        </div>
            ...
            <div class="col-lg-7 mb-5">
                <div class="contact-form">
                    ...
                    <form method="POST" name="sentMessage" id="contactForm" novalidate="novalidate">
                        ...
                        <div>
                            <button name="connecter" class="btn btn-primary py-2 px-4 w-100" type="submit">
                                Se connecter
                            </button>
                        </div>
                    </form>
