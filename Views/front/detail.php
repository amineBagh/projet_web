          ...
          >
            ...
            >
              <div class="navbar-nav mr-auto py-0">
                ...
                <a href="detail.php" class="nav-item nav-link active"
                  >Shop Detail</a
                >
                <div class="nav-item dropdown">
                  <a
...
$listeC = $commentaireC->CommentaireProduit(123);
foreach($listeC as $comm){
?>

    <p class="lead"> <?php echo $comm['texte'];?> </p> 
      <style>
          p {
            border:1px dotted black;
                   ...
                   <!-- <input height="300" type="text" id="commentaire" name="commentaire" class="Input-text" placeholder="Your comment..."> -->
                   <textarea id="commentaire"  name="commentaire" rows="5" cols="33" placeholder="Your comment...">
                       </textarea>
